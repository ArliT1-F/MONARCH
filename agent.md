...
| `YTDLP_COOKIES` (`YTDLP_COOKIE_FILE`) | when YouTube asks for a bot check | bot music | Netscape cookies.txt exported from a throwaway account; `YTDLP_PROXY`, `YTDLP_ARGS`, `YTDLP_FORMAT`, `YTDLP_CACHE_DIR` are the other yt-dlp knobs |
