  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-6 sm:px-8 sm:py-10">
      ...
      <p className="mb-6 text-sm leading-relaxed text-ink-300 sm:mb-8">
        A template is a portable copy of a server layout. Export one to share your structure or keep
        it outside Monarch; import one to set up a server in seconds — always with a full diff
