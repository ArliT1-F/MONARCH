  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="ml-60 min-w-0 flex-1">
        {!guild.botInstalled && (
          <div className="border-b border-warn-400/20 bg-warn-400/10 px-6 py-2 text-xs text-warn-400">
            Monarch isn&apos;t installed in this server — designing is read-only until the bot is invited.
          </div>
        )}
        {children}
      </div>
